...
SERVICE_PORT = 9000
SERVICE_ADDRESS = os.getenv("SERVICE_ADDRESS", "orchestrator-agent")
...
def discover_service(name: str) -> str:
    """El orquestador usa esto para encontrar DÓNDE está cada agente --
    equivalente a lo que hace booking-svc con Consul para encontrar
    notif-svc. La pregunta de 'dónde está' se resuelve por Consul; la
    pregunta de 'qué sabe hacer' se resuelve leyendo su Agent Card."""
